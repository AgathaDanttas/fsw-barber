...
export default function BarberCard({title, address,image}:BarberProps){
    return (
        <div className="w-[220.8px] h-[295px] bg-secondary_black border border-gray1 rounded-2xl pt-1 px-1 relative">
            
           
                <img src={image} alt={`Image da Barbearia ${Image}`} className="w-[213px] h-[159px] rounded-2xl"/>
